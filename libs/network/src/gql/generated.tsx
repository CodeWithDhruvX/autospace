...
export type Admin = {
  ...
  updatedAt: Scalars['DateTime']['output'];
  verfications?: Maybe<Verification>;
  verficationsCount: Scalars['Float']['output'];
};
